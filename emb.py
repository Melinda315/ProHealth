...
with open('./data/node.dat','r') as original_meta_file:
...
with open('./data/link.dat', 'r') as original_meta_file:
    for line in original_meta_file:
...
line_name[0]="has"
line_name[1]="for"
line_name[2]="including"
line_name[3]="given_at"
...
with open('./data/val_corpus.txt', 'w') as file:
    for paragraph in val_text:
        file.write(paragraph + "\n")


datasets = load_dataset("text", data_files={"train": './data/train_corpus.txt',
                                            "validation": './data/val_corpus.txt'})
...
with open('./data/emb.dat', 'w') as file:
    file.write('prohealth\n')
    for i in range(len(op2)):
        file.write(f'{i}\t')
